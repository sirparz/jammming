...
const redirectUri = 'https://sirparz.github.io/jammming'; // Have to add this to your accepted Spotify redirect URIs on the Spotify API.
let accessToken;
...
const Spotify = {
  ...
  async search(term) {
    ...
    return jsonResponse.tracks.items.map(track => ({
      id: track.id,
      title: track.name,
      artist: track.artists.map((item) => item.name),
